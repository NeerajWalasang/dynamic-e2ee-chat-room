...
// src/encryptionService.js
export async function fetchDynamicKey(messages, sessionId, senderId, receiverId) {
  const resp = await fetch('http://localhost:5001/generate-key', {
    method: 'POST',
